...
def main():
    ...
    parser.add_argument('--path', default=r'D:\confocal_Thy1_neuron/')

    parser.add_argument('--min_v', type=int, default=0)
    parser.add_argument('--max_v', type=int, default=4095)
    ...
    train_set=pytorch_dataset.create_train_data(args.path+'train_data/',args.batch_size,args.min_v,args.max_v)
